...
-define(STRING_TAG_UTF8, 12).
-define(STRING_TAG_PRINTABLE, 19).

convert_attribute_value(<<?STRING_TAG_UTF8, Length:8, Value:Length/binary>>) ->
    binary_to_list(Value);
convert_attribute_value(<<?STRING_TAG_PRINTABLE, Length:8, Value:Length/binary>>) ->
    binary_to_list(Value).
